...
class Thermochemistry(seamm.Node):
    """
    ...
    def __init__(
        ...
        namespace="org.molssi.seamm.thermochemistry",
        extension=None,
        logger=logger
    ):
    ...
    def description_text(self, P=None):
        ...
        while node is not None:
            try:
                ...
                print(
                    f"Error describing thermochemistry flowchart: {e} in {node}"
                )
                logger.critical(
                    f"Error describing thermochemistry flowchart: {e} in {node}"
                )
                ...
                print(
                    "Unexpected error describing thermochemistry flowchart: {} in {}"
    ...
    def run(self):
        ...
        result = local.run(
            cmd=["Thermochemistry", "-in", "molssi.dat"],
            files=files,
            return_files=[]
        )  # yapf: disable

        if result is None:
            logger.error("There was an error running Thermochemistry")
            return None
