...
do
	...
	sphinx-apidoc -o docs/developer thermochemistry_step
...
<html>
   <head>
      <title>Documentation for the Thermochemistry plug-in for SEAMM</title>
   </head>
   <body>
      <h1>Documentation for the Thermochemistry plug-in for SEAMM</h1>
      <h2>Branches</h2>
      <ul>
EOF
